package com.kgc.buycar.controller;
...
public class BuyCarController {
    ...
    //合并用户登录后的购物车
    @RequestMapping("/loginBuyCar")
    public @ResponseBody Map<String, Object> loginBuyCar(Integer uid, HttpServletRequest request, HttpServletResponse response){
