...
<div class="soubg">
	<div class="sou">
        ...
        <span class="fr">
            ...
            <span class="fl"><a href="#" id="exitUser">注销</a>|&nbsp;关注我们：</span>
...
<script type="text/javascript">
    jQuery(function () {
        ...
        jQuery("#addBuyCarBtn").click(function () {
            ...
            jQuery.ajax({
                type:'post',
                url:'http://localhost:7076/buyCar/addBuyCar',
        ...
        //登陆后合并购物车
        function loginBuyCar(uid){
            jQuery.ajax({
                type:"POST",
                xhrFields:{withCredentials:true}, //允许ajax的跨域访问获取cookie
                url:"http://localhost:7076/buyCar/loginBuyCar",
                data:{"uid":uid},
                success:function (data) {
                    console.log(data);
                    loadBuyCar(token);  //加载购物车数据
        ...
        function loadBuyCar(token){
            ...
            jQuery.ajax({
                type:"POST",
                xhrFields:{withCredentials:true}, //允许ajax的跨域访问获取cookie
                url:"http://localhost:7076/buyCar/loadBuyCar",
                data:{"token":token},
                success:function (data) {
                    console.log(data);
                    if(data.length!=0){
