package com.kgc.orders.controller;

import com.kgc.model.WebOrderEntity;
import com.kgc.model.WebUsersEntity;
import com.kgc.orders.utils.OrderUtils;
...
public class OrdersController extends BaseController<WebOrderEntity> {
    ...
    @RabbitListener(bindings = @QueueBinding(
            value=@Queue(value = "e_buy"),  //队列的名字
            exchange = @Exchange(value = "e_commerce_seckill",type = "headers")  //交换机的名字,交换机的类型
    ))  //配置发送数据的交换机和队列的基本信息
     ...
     */
    @RabbitListener(bindings = @QueueBinding(
            value=@Queue(value = "e_buycar"),  //队列的名字
            exchange = @Exchange(value = "e_commerce_seckill",type = "headers")  //交换机的名字,交换机的类型
    ))  //配置发送数据的交换机和队列的基本信息
    @RabbitHandler   //配置自动发送数据到订单模块
